...
cskill1000014 = class("cskill1000014",super,{
	type = 1000014,
	name = "龙息术",
	canuse = 1,
	cd = 2,
...
function cskill1000014:init(option)
	super.init(self,option)
--<<skill 导表结束>>

end --导表生成

function cskill1000014:get_targets(focus)
...
function cskill1000014:do_effect(effect,target,focus)
	local caster = self.owner
...
function cskill1000014:base_damage()
	local caster = self.owner
	return caster.lv * 100
end

return cskill1000014
